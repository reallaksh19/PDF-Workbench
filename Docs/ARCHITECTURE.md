...
| PDF rendering     | PDF.js           | 4.x     | Canvas + text layer                              |
| PDF manipulation  | pdf-lib          | 1.x     | Preview mode only — merge/split in browser       |
| Annotation canvas | Fabric.js        | 6.x     | Rich object model, serializable                  |
...
| OCR equations     | pix2tex               | 0.1.x   | LaTeX from image; best-effort accuracy           |
